        ...
        <!-- User Info Section -->
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <label for="state"><strong>Renk</strong></label>
                    <select name="rank" id="state" class="form-control" >
                        <option value="">Select Renk</option>
                        @php $selected = isset($user->StudentInfo->rank) ? $user->StudentInfo->rank : '0';  @endphp
                        @for ($i = 1; $i <= $topperNumbers; $i++)
                            @php $select = ($selected == $i) ? 'selected' : ''; @endphp
            ...
            <!-- Informed Faculty and Principal Name -->
            <div class="row">
                <div class="col-md-6 col-sm-12">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <label for="college_code"><strong>College Code:</strong></label>
                    <input type="text" id="college_code" name="college_code" class="form-control" value="{{ $user->studentInfo->collegeData->college_code ?? 'N/A' }}">
                </div>
                <div class="col-md-6 col-sm-12">
